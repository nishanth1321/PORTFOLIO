...
const Education = () => {
  return (
    <div className="hover:scale-105 transition-transform duration-300 relative w-[100%] max-w-4xl p-6 bg-blue-100/10 rounded-lg shadow-lg h-[270px] backdrop-blur-sm md:p-12">
